...
def cmd_callback(data):
    ...
    gear = 0
    speed = math.floor(data.twist.linear.x)
    steer = math.floor(data.twist.angular.z)
    brake = 1
    print(steer)
...
if __name__ == '__main__':
    ...
    cmd_sub = rospy.Subscriber("cmd_vel",TwistStamped,cmd_callback)
    cmd_safe_sub = rospy.Subscriber("cmd_vel_safe",TwistStamped,cmd_callback)
