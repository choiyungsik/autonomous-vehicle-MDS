...
public:
    ...
    camLidarCalib(ros::NodeHandle n) {
        ...
        // cloud_sub_ = nh.subscribe(lidar_in_topic, 1, &camLidarCalib::pointcloudCallback,this);
	    // image_sub_ = nh.subscribe(camera_in_topic, 1, &camLidarCalib::imageCallback,this);
